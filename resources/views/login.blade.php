...
<body class="bg-slate-800">
    <div class="mx-auto p-4 w-full max-w-md h-full md:h-auto bg-gray-700 rounded-lg mt-20">
        ...
        <form class="space-y-6" id="form-login" method="post">
            ...
            <button type="submit" id="btn-login" class="-full text-white focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-blue-600 hover:bg-blue-700 focus:ring-blue-800">Login</button>
        </form>
    </div>
    {{--  url --}}
